...
class Kohana_OriginalView {
	...
	public static function set_global($key, $value = NULL)
	{
		if (is_array($key))
		{
			...
			{
				OriginalView::$_global_data[$key2] = $value;
			}
		}
		else
		{
			OriginalView::$_global_data[$key] = $value;
		}
	}
	...
	public function & __get($key)
	{
		...
		elseif (isset(OriginalView::$_global_data[$key]))
		{
			return OriginalView::$_global_data[$key];
		}
		else
		{
	...
	{
		return (isset($this->_data[$key]) OR isset(OriginalView::$_global_data[$key]));
	}
	...
	{
		unset($this->_data[$key], OriginalView::$_global_data[$key]);
	}
	...
	public function render($file = NULL)
	{
		...
		return OriginalView::capture($this->_file, $this->_data + OriginalView::$_global_data);
	}
